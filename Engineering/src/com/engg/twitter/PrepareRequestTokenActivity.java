...
import com.engg.solution.Questions;
...
public class PrepareRequestTokenActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.v("debug", "PrepareRequestTokenActivity");
		Toast.makeText(getApplicationContext(), "PrepareRequestTokenActivity", Toast.LENGTH_SHORT)
				.show();
	...
	public void onNewIntent(Intent intent) {
		...
		Log.v("debug", "PrepareRequestTokenActivity");
		Toast.makeText(getApplicationContext(), "PrepareRequestTokenActivity in  onnewintent", Toast.LENGTH_SHORT)
				.show();
		Log.v("debug", "inside onNewIntent");
	...
	public class RetrieveAccessTokenTask extends AsyncTask<Uri, Void, Void> {
		...
		protected Void doInBackground(Uri... params) {
			...
			try {
				...
				context.startActivity(new Intent(context, Questions.class));
